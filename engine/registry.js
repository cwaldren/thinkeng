...
export const ENTRIES = [
  ...
  },
  {
    ...
    actions: [{ label: "Puff", method: "puff" }],
  },
  {
    category: "insect",
    key: "bumblebee",
  ...
  },
  {
    ...
    tags: ["misc"],
    label: "Fence",
    desc: "Wooden fence: posts with crossing X boards (component)",
    fn: createFence,
    opts: [
      {
        key: "postHeight",
      ...
      { key: "postColor", label: "Post Color", type: "color", default: "0x922b2c" },
      { key: "boardColor", label: "Board Color", type: "color", default: "0xba9a59" },
      {
        key: "position",
        label: "Position [x,y,z]",
        type: "vector",
  ...
  },
  {
    ...
    tags: ["plant"],
    label: "Tree",
    desc: "A pine tree: tapered trunk with two cone foliage tiers (component)",
    fn: createTree,
    opts: [
      {
        key: "scale",
  ...
  },
  {
    ...
    tags: ["insect"],
    label: "Firefly",
    desc: "A tiny black firefly that blinks warm yellow every few seconds",
    fn: createFirefly,
    opts: [
      {
        key: "size",
      ...
      { key: "glowColor", label: "Glow Color", type: "color", default: "0xffd97d" },
      {
        key: "blinkEveryMin",
        label: "Blink Interval Min (s)",
        type: "number",
        default: 5,
        min: 1,
        max: 20,
