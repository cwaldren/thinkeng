...
/**
 * Copies a CANNON body's position and quaternion into a THREE mesh.
 */
...
/**
 * Sets a CANNON body's pose from any {x,y,z} / {x,y,z,w} source (e.g. a
 * THREE.Vector3 / THREE.Quaternion). The quaternion argument is optional.
 */
export function setBodyPose(body, position, quaternion = null) {
